...
- Authenticated workspace visual regression: compare desktop and mobile captures to `SPEC/mockups/ideas-boards-comp-06-jira-editorial-board.html`. Verify the horizontal navy shell, typography and color tokens, dense Boards/Ideas lists, open Board canvas, status-colored lane rules, white bordered cards, Add New split form, and approximately 85vw mobile lane overflow without importing the comp switcher or static demo behavior.