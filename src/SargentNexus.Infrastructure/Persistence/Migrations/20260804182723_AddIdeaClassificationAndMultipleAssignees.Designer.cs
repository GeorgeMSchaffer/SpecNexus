...
namespace SargentNexus.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260804182723_AddIdeaClassificationAndMultipleAssignees")]
    partial class AddIdeaClassificationAndMultipleAssignees
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SargentNexus.Domain.BusinessImpact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SargentNexus.Domain.IdeaAssignee", b =>
                {
                    b.Property<Guid>("IdeaId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SargentNexus.Domain.IdeaType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SargentNexus.Domain.Organization", b =>
                {
                    ...
                    b.Property<DateTime>("InviteCodeGeneratedAtUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SargentNexus.Domain.Idea", b =>
                {
                    ...
                    b.HasOne("SargentNexus.Domain.BusinessImpact", "BusinessImpact")
                        .WithMany("Ideas")
                        .HasForeignKey("BusinessImpactId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SargentNexus.Domain.IdeaType", "IdeaType")
                        .WithMany("Ideas")
            ...
            modelBuilder.Entity("SargentNexus.Domain.Organization", b =>
                {
                    ...
                    b.Navigation("BusinessImpacts");

                    b.Navigation("IdeaTypes");
